<?php
// source: /root/zaznamnik-snu/config/common.neon
// source: /root/zaznamnik-snu/config/services.neon
// source: /root/zaznamnik-snu/config/local.neon
// source: array
...
class Container_335e54c2b7 extends Nette\DI\Container
{
	...
	public function createServiceApplication__presenterFactory(): Nette\Application\IPresenterFactory
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback(
			$this,
			5,
			'/root/zaznamnik-snu/temp/cache/nette.application/touch',
		));
	...
	{
		return new Nette\Caching\Storages\FileStorage('/root/zaznamnik-snu/temp/cache');
	}
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\LatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\LatteFactory {
			public function __construct(
				private Container_335e54c2b7 $container,
			) {
			}
			...
			public function create(): Latte\Engine
			{
				...
				$service->setTempDirectory('/root/zaznamnik-snu/temp/cache/latte');
